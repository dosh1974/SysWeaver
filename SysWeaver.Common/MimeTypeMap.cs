...
namespace SysWeaver
{
    ...
    {
        /// <summary>
        /// Mime type suffix for Utf8 encoded content
        /// </summary>
        ...
        /// </summary>
        public const string PlainText = "text/plain" + Utf8Suffix;

        /// <summary>
        /// UTF8 encoded html document
        /// </summary>
        public const string Html = "text/html" + Utf8Suffix;
        ...
        /// </summary>
        public const string FormUrlEncoded = "application/x-www-form-urlencoded" + Utf8Suffix;
        ...
        static readonly IReadOnlyDictionary<string, Tuple<string, bool>> Map;

        static readonly IReadOnlyDictionary<string, Tuple<string, bool>> MapWithCharSet;

        static readonly IReadOnlyDictionary<string, String[]> MimeExtensions;
        ...
        static readonly IReadOnlySet<String> Utf8Apps = ReadOnlyData.Set(StringComparer.Ordinal,
            "application/postscript",
            "application/xml",
            "application/olescript",
            "application/x-java-applet",
        ...
        static bool Compressable(String mime)
        {
            if (mime.StartsWith("text/", StringComparison.Ordinal))
                return true;
            return CompressibleApps.Contains(mime);
        }

        static bool AssumeUtf8(String mime)
        {
            if (mime.StartsWith("text/", StringComparison.Ordinal))
                return true;
            return Utf8Apps.Contains(mime);
        }
        ...
        static MimeTypeMap()
        {
            ...
            Dictionary<String, Tuple<String, bool>> mimes = new(StringComparer.Ordinal);
            Dictionary<String, Tuple<String, bool>> mimesWithCharSet = new(StringComparer.Ordinal);
            Dictionary<String, HashSet<String>> mimeExts = new(StringComparer.Ordinal);
            void addMime(String mime, String ext)
            {
                if (!mimeExts.TryGetValue(mime, out var x))
                {
                    x = new HashSet<string>(StringComparer.Ordinal);
                    mimeExts[mime] = x;
                }
                x.Add(ext);
            }
            ...
            Dictionary<String, String[]> mimeExtsF = new(StringComparer.Ordinal);
            foreach (var x in mimeExts)
