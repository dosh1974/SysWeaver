...
namespace SysWeaver
{
    ...
    public sealed class FrozenStringTree : IStringTree
    {
        ...
        /// </summary>
        /// <returns></returns>
        void InternalAddAllInOrder(List<String> found, FrozenStringTree node)
        {
            var n = node.Nodes;
            if (n == null)
                return;
        ...
        /// </summary>
        /// <returns></returns>
        void InternalAddAll(List<String> found, FrozenStringTree node)
        {
            var n = node.Nodes;
            if (n == null)
                return;
        ...
        readonly IReadOnlyDictionary<Char, FrozenStringTree> Nodes;
        ...
        public FrozenStringTree(StringTree tree)
        {
            ...
            if (n != null)
            {
                var d = new Dictionary<Char, FrozenStringTree>(n.Comparer);
                foreach (var x in n)
                    d.Add(x.Key, new FrozenStringTree(x.Value));
                Nodes = d.Freeze();
            }
