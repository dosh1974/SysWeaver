...
namespace SysWeaver.MicroService
{
    ...
    public class WebMenuEmbeddedAttribute : WebMenuAttribute
    {
        ...
        /// </param>
        public WebMenuEmbeddedAttribute(String menu, String id, String name, String url, String title = null, String iconClass = null, float order = 0, String auth = null, bool noUserRequired = false, String dynamic = null)
            : base(menu, id, WebMenuItemTypes.Embedded, name, title, iconClass, order, auth, noUserRequired, url, dynamic)
        {
        }
    }
