...
namespace SysWeaver.MicroService
{
    ...
    public class WebMenuJsAttribute : WebMenuAttribute
    {
        ...
        public WebMenuJsAttribute(String menu, String id, String name, String jscode, String title = null, String iconClass = null, float order = 0, String auth = null, bool noUserRequired = false, String dynamic = null)
            : base(menu, id, WebMenuItemTypes.Js, name, title, iconClass, order, auth, noUserRequired, jscode, dynamic)
        {
        }
    }
