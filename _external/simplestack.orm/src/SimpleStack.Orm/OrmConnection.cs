...
namespace SimpleStack.Orm
{
    public partial class OrmConnection : DbConnection
    {
        ...
        public OrmConnection(DbConnection connection, IDialectProvider dialectProvider, ILoggerFactory loggerFactory)
        {
        ...
        /// <summary>
        /// Command timeout (in seconds) for command created from this connection
        /// </summary>
