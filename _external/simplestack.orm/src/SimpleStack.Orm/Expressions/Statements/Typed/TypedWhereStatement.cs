...
namespace SimpleStack.Orm.Expressions.Statements.Typed
{
    public abstract class TypedWhereStatement<T>
    {
        ...
        /// <returns>A SqlExpressionVisitor&lt;T&gt;</returns>
        public TypedWhereStatement<T> Where(String func)
        {
            And(func);
        ...
        /// <param name="func">The where function.</param>
        /// <returns>A SqlExpressionVisitor&lt;T&gt;</returns>
        public TypedWhereStatement<T> And(String func)
        {
            if (func == null)
            {
                return this;
            ...
            Where(GetExpressionVisitor(), func);
            return this;
        }
        ...
        /// <param name="func">The where function.</param>
        /// <returns>A SqlExpressionVisitor&lt;T&gt;</returns>
        public TypedWhereStatement<T> Or(String func)
        {
            if (func == null)
            {
                return this;
            ...
            Where(GetExpressionVisitor(), func, "OR");
            return this;
        }
        ...
        internal void Where(ExpressionVisitor visitor, String func, string op = "AND")
        {
            if (WhereStatement.WhereExpression.Length > 0)
            {
                WhereStatement.WhereExpression.Insert(0, " (");
                ...
                WhereStatement.WhereExpression.Append(op);
                WhereStatement.WhereExpression.Append(" ");
                WhereStatement.WhereExpression.Append(func);
                WhereStatement.WhereExpression.Append(')');
            }
            else
            {
