...
namespace SimpleStack.Orm
{
    ...
    public class ModelDefinition
    {
        ...
        /// <param name="tableName">Optionally override withthis table name</param>
        /// <returns></returns>
        public static ModelDefinition Get(Type modelType, string tableName = null) => modelType.GetModelDefinition(tableName);
