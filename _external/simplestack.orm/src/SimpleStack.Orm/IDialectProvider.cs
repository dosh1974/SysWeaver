...
namespace SimpleStack.Orm
{
    ...
    public interface IDialectProvider
    {
        ...
        CommandDefinition ToSelectStatement(SelectStatement statement, CommandFlags flags, CancellationToken cancellationToken = new CancellationToken(), int? commandTimeout = null);
        ...
        IEnumerable<IColumnDefinition> GetTableColumnDefinitions(IDbConnection connection, string tableName,
