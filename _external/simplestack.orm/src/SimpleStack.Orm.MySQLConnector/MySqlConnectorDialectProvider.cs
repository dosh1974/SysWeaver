...
namespace SimpleStack.Orm.MySQLConnector
{
    ...
    public class MySqlConnectorDialectProvider : DialectProviderBase
    {
	    ...
	    ///     being created.
	    /// </summary>
	    protected MySqlConnectorDialectProvider() : base(new MySqlConnectorTypeMapper())
        {
        ...
        public static readonly MySqlConnectorDialectProvider Instance = new MySqlConnectorDialectProvider();
        ...
        {
            var query = new StringBuilder(insertStatement.IgnoreErrors ? "INSERT IGNORE INTO " : "INSERT INTO ");
